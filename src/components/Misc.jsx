  ...
  return (
    <>
      <section className="fadein px-6">
        ...
        <div>
          <img src={crystal} className="max-w-xl w-11/12 p-6" alt="image of out my window" />
          <p className="w-40 absolute top-40 left-24 md:top-60 md:left-60 text-2xl md:text-3xl">
            see some of my past adventures
            <Link className="adventure font-semibold" to='https://lapaztravels.wordpress.com/' target='blank'> here</Link>.</p>
        </div>
      </section>
    </>
  );
